...
print("Vous vous trouvez actuellement ici :");
print($rep);
...
<input type="hidden" name="pathren" value="'.$replien.'" />
	...
	print("La machine ne semble pas être allumée, si celle-ci est allumée merci de prendre contact avec un responsable !");
}
