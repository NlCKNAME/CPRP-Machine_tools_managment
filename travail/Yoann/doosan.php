...
$DEFAULT="C:\machine\doosan"; /*Default redirection quand le script commence*/
  ...
  <header id="header" class="clear">
    ...
    <nav>
      ...
      <ul>
        ...
        <li><a href="doosan.php" style=" color: #FF9900;">DOOSAN<span><img title="DOOSAN"  title="DOOSAN" src="img/doosan.jpg" style="width: 500px;" /></span></a></li>
	...
	<div style="width:20%; float:left" align="right">
		<li><a href="#" onclick="display_('upload');"><img title="Envoyer un fichier"  title="Telecharger un fichier" src="<?php echo $IMGUPLOAD; ?>" /></a></li>
...
echo '<a href="?delete='.$replien.'/'.$lien.'" onclick="return confirm(\'Supprimer '.$f.' ?\');"><img alt="Supprimmer" title="/!\Supprimer/!\ " src="img/delete.gif" style="vertical-align:middle"/></a>';
	...
	echo '&nbsp&nbsp&nbsp<a href="?dir='.$_GET['dir'].'&renom='.$lien.'" ><img title="Renommer"  title="Renommer" src="'.$IMGRENAME.'"style="vertical-align:middle" /></a>'; 
	 ...
	 echo '&nbsp&nbsp&nbsp<a href="?download='.$replien.'/'.$lien.'" ><img alt="Telecharger" title="Recevoir " src="img/download.png"style="vertical-align:middle" /></a><br />';
