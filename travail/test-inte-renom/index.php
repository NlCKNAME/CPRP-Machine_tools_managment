...
echo '<a href="?deletedir='.$replien.'/'.$lien.'" onclick="return confirm(\'Supprimer '.$f.' ?\');"><img alt="Supprimmer" title="/!\Supprimer/!\ " src="img/delete.gif" /></a>';
     ...
     echo '<a href="?dir='.$_GET['dir'].'/'.$lien.'/"><img alt="Dossier" src="'.$IMGFOLDER.'" />'.$f.'</a>';
	echo '&nbsp&nbsp&nbsp<a href="?dir='.$_GET['dir'].'&renom='.$lien.'" ><img title="Renommer"  title="Renommer" src="'.$IMGRENAME.'" /></a><br />'; 
...
echo '<a href="?delete='.$replien.'/'.$lien.'" onclick="return confirm(\'Supprimer '.$f.' ?\');"><img alt="Supprimmer" title="/!\Supprimer/!\ " src="img/delete.gif" /></a>';
	 ...
	 echo '<img src="'.$IMGFILE.'" alt="Fichier"/>'.$f.'';
	 
	echo '&nbsp&nbsp&nbsp<a href="?dir='.$_GET['dir'].'&renom='.$lien.'" ><img title="Renommer"  title="Renommer" src="'.$IMGRENAME.'" /></a>'; 
   
	 echo '&nbsp&nbsp&nbsp<a href="?download='.$replien.'/'.$lien.'" ><img alt="Telecharger" title="Telecharger " src="img/download.png" /></a><br />';
